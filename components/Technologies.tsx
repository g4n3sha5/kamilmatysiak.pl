...
const tools = [
    ...
    {name: "Photoshop", icon: Photoshop}, {name: "Slack", icon: Slack}, {
...
const TechComponent = (Tech) => {
    return (<div key={Tech.name} aria-hidden="true" className="techWrapper rajdhani">
        <h6>{Tech.name}</h6>
...
const TechDiv = ({arr}) => {
    return (<div className="technologies pb-lg-3 mt-lg-2 my-3 px-lg-3">
